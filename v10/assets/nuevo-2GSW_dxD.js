import{n as e}from"./vendor-BuoCFfzO.js";import{C as t,P as n,S as r,a as i,b as a,i as o,o as s,p as c,v as l}from"./rutas-B_x8p2ls.js";import{D as u,m as d,w as f,x as p,y as m}from"./firebase-D3TdL7f_.js";import{n as h}from"./firebase-Cf7EPvid.js";import{a as g,b as _,o as v,t as y,u as b}from"./devblog-gv0I7wIJ.js";var x=e=>e.trim().toLowerCase().normalize(`NFD`).replace(/[\u0300-\u036f]/g,``).replace(/\b(el|la|los|las|de|del|en|un|una|y|a|con|por|para|que|es|se)\b/g,` `).replace(/[^a-z0-9\s]/g,``).replace(/\s+/g,`_`).replace(/_{2,}/g,`_`).replace(/^_|_$/g,``).slice(0,50),S=e=>{let t=e.replace(/<[^>]*>/g,` `).split(/\s+/).filter(Boolean);return{words:t.length,min:Math.max(1,Math.ceil(t.length/200))}},C=()=>a.params()?.edit||new URLSearchParams(location.search).get(`edit`)||null,w=()=>{let e=l.user?.usuario?l.user:c(`wiSmile`)||{};if(!e.email)return`<div class="nu_err dpvc"><i class="fas fa-lock"></i><h2>Acceso restringido</h2><p>Inicia sesión para crear historias</p></div>`;let r=C();return`
  <div class="nu_wrap">
    <div class="nu_head">
      ...
      <div class="nu_left">
        <div class="nu_card">
          ...
          <div class="nu_slug_box">
            <span class="nu_slug_label"><i class="fas fa-link"></i> ${n}</span>
...
---
`,`Separador`]],[[`fa-code`,"`código`",`Código`],[`fa-image`,`![desc](url)`,`Imagen`],[`fa-link`,`[texto](url)`,`Enlace`]]].map((e,n)=>`<div style="display:flex;gap:0.4vh${n<3?`;border-right:1px solid var(--brd);padding-right:0.6vh;margin-right:0.2vh`:``}">${e.map(([e,n,r])=>`<button type="button" class="nu_tool" data-tag='${n}' ${t(r)}><i class="fas ${e}"></i></button>`).join(``)}</div>`).join(``)}</div>
      ...
      <div class="nu_right">
        ...
        <div class="nu_card">
          ...
          <div style="display:flex; flex-direction:column; gap:1vh;">
            ...
            <div id="nu_img_top_prev" class="nu_img_prev dpn"><img id="nu_img_top_el" src="" alt=""/><button type="button" id="nu_img_top_clear" class="nu_img_clear" ${t(`Quitar`)}><i class="fas fa-xmark"></i></button></div>
          </div>
        </div>
