...
<div class="dc_wrap">
  <div class="dc_hero wi_fadeUp" style="--d:0s">
    <div class="dc_badge"><i class="fas fa-feather-pointed"></i> Descubre ${app}</div>
    <h1 class="dc_title">Productividad,<br>Orden y <span class="dc_grad">Tecnología</span></h1>
    <p class="dc_desc">Explora la funcionalidad avanzada de ${app}. Una herramienta profesional, intuitiva y privada, diseñada para organizar y ejecutar tus proyectos más importantes.</p>
  </div>
