import{n as e}from"./vendor-BuoCFfzO.js";import{l as t}from"./wii-DQBqtwtl.js";import{_ as n,b as r,l as i,m as a,n as o,t as s,y as c}from"./widev-BX5_JJ6V.js";import{i as l}from"./index-ChQt8nr5.js";import{c as u,g as d,p as f,r as p,u as m}from"./firebase-BuEyh8Mq.js";import{n as h}from"./firebase-CKBWl3dx.js";import{a as g,b as _,o as v,t as y,u as b}from"./devblog-CgLbCEdi.js";var x=e=>e.trim().toLowerCase().normalize(`NFD`).replace(/[\u0300-\u036f]/g,``).replace(/\b(el|la|los|las|de|del|en|un|una|y|a|con|por|para|que|es|se)\b/g,` `).replace(/[^a-z0-9\s]/g,``).replace(/\s+/g,`_`).replace(/_{2,}/g,`_`).replace(/^_|_$/g,``).slice(0,50),S=e=>{let t=e.replace(/<[^>]*>/g,` `).split(/\s+/).filter(Boolean);return{words:t.length,min:Math.max(1,Math.ceil(t.length/200))}},C=()=>n.params()?.edit||new URLSearchParams(location.search).get(`edit`)||null,w=()=>{let e=a.user?.usuario?a.user:i(`wiSmile`)||{};if(!e.email)return`<div class="nu_err dpvc"><i class="fas fa-lock"></i><h2>Acceso restringido</h2><p>Inicia sesión para crear historias</p></div>`;let n=C();return`
  <div class="nu_wrap">
    <div class="nu_head">
