import{n as e}from"./vendor-BuoCFfzO.js";import{O as t,f as n,h as r,n as i,p as a,s as o,v as s}from"./rutas-CMyKUOUs.js";import{C as c,S as l,h as u,v as d}from"./firebase-D3TdL7f_.js";import{n as f}from"./firebase-D4Yi1kXi.js";var p=()=>{let e=new Date;return`${e.getFullYear()}-${String(e.getMonth()+1).padStart(2,`0`)}`},m=async e=>{try{let t=`empleadosPuntos_${e}`,n=a(t);if(n)return console.log(`🏆 Ranking del mes ${e} recuperado de caché local.`),n;console.log(`🔄 Calculando ranking en vivo desde Firestore para el mes ${e}...`);let i=(await u(d(c(f,`smiles`),l(`participa`,`==`,`si`)))).docs.map(e=>{let t=e.data();return{usuario:t.usuario||e.id,nombre:t.nombre||t.usuario||e.id,descripcion:t.descripcion||`Colaborador`,imagen:t.imagen||``,totalPuntos:0,totalVentas:0}}),o=await u(c(f,`registrosdb`)),[s,p]=e.split(`-`).map(Number);return o.docs.forEach(e=>{let t=e.data(),n=t.fechaTour,r,a;if(typeof n==`string`)[r,a]=n.split(`-`).map(Number);else if(n?.toDate){let e=n.toDate();r=e.getFullYear(),a=e.getMonth()+1}else return;if(r===s&&a===p){let e=i.find(e=>e.usuario===t.vendedor);e&&(e.totalPuntos+=parseInt(t.puntos)||0,e.totalVentas+=parseInt(t.qventa)||1)}}),i.sort((e,t)=>t.totalPuntos===e.totalPuntos?t.totalVentas===e.totalVentas?e.nombre.localeCompare(t.nombre):t.totalVentas-e.totalVentas:t.totalPuntos-e.totalPuntos),r(t,i,5),i}catch(e){return console.error(`Error en obtenerRankingMes (zsmile):`,e),[]}},h=p(),g=()=>`
    <div class="smw_dash">
