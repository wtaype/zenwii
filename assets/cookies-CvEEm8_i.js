...
<div class="ac_wrap tm_wrap">
  ...
  <section class="ac_sec ac_sec_alt">
    ...
    <div class="tm_alert" style="max-width:800px;margin:6vh auto 0">
      ...
      <p>Limpiar el almacenamiento local del navegador cerrará tu sesión activa, restablecerá el tema estético a la configuración por defecto y forzará la recarga de datos la próxima vez que ingreses a ${t}.</p>
    </div>
  </section>

</div></main>`,s=null,c=()=>{s=new IntersectionObserver(t=>t.forEach(t=>{t.isIntersecting&&e(t.target).addClass(`visible`)}),{threshold:.1}),e(`.wi_fadeUp`).each(function(){s.observe(this)}),e(document).on(`click.cookies`,`.tm_nav`,function(t){t.preventDefault(),r(()=>import(`./index-D0_1N-AK.js`).then(e=>e.r).then(t=>t.rutas.navigate(e(this).attr(`href`))),[])}),console.log(`🍪 ${t} Cookies cargada`),window.__WIREADY__=!0},l=()=>{s?.disconnect?.(),s=null,e(document).off(`.cookies`)};export{l as cleanup,c as init,o as render};