import{n as e}from"./vendor-BuoCFfzO.js";import{i as t,t as n}from"./wii-DQBqtwtl.js";import{C as r,T as i,_ as a,d as o,g as s,h as c,r as l,x as u}from"./widev-DfeMkeQH.js";import{t as d}from"./preload-helper-Dq_6WaEp.js";import{c as f,f as p,m,n as h,o as g,p as _,r as v,s as y,u as b,v as x,y as S}from"./devblog-C8pZ2qLL.js";e(`#wiad_styles`).length||e(`<style id="wiad_styles">`).text(`
...
`,w=e=>`<a href="/${e.slug||e.id}" class="po_rel_card" ${r(e.resumen||e.titulo)}><div class="po_rel_img"><img src="${e.imagen}" alt="${e.imagenAlt||e.titulo}" loading="lazy"/></div><div class="po_rel_info"><span class="po_rel_cat"><i class="fas fa-paw"></i> ${e.categoria}</span><strong>${e.titulo}</strong><span class="po_rel_meta"><i class="fas fa-calendar"></i> ${x(e.actualizado||e.creado)} · <i class="fas fa-eye"></i> ${e.vistas||0} · <i class="fas fa-heart" style="color:#fe0149"></i> ${e.likes||0}</span></div></a>`,T=(e,t,n=`po_fade po_visible`)=>e||t?`
    ...
    </div>`:``,E=(e,i,o,s,c)=>{let l=a.user?.usuario,u=c?`po_fade po_visible`:`po_fade`,d=i!==null&&o!==null,f=i||[],p=o||[],m=f[0]||p[0],h=f[1]||p[1],g=d?T(m,h,u):`<div id="po_nav_container"></div>`;return`
