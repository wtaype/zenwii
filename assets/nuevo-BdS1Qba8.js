import{n as e}from"./vendor-BuoCFfzO.js";import{l as t}from"./wii-DQBqtwtl.js";import{C as n,a as r,i,o as a,p as o,w as s,x as c,y as l}from"./rutas-Cm_3kJJL.js";import{_ as u,d,i as f,l as p,m}from"./firebase-D_Qc_hgv.js";import{n as h}from"./firebase-CkLzmU2G.js";import{a as g,b as _,o as v,t as y,u as b}from"./devblog-B2S2RHaA.js";var x=e=>e.trim().toLowerCase().normalize(`NFD`).replace(/[\u0300-\u036f]/g,``).replace(/\b(el|la|los|las|de|del|en|un|una|y|a|con|por|para|que|es|se)\b/g,` `).replace(/[^a-z0-9\s]/g,``).replace(/\s+/g,`_`).replace(/_{2,}/g,`_`).replace(/^_|_$/g,``).slice(0,50),S=e=>{let t=e.replace(/<[^>]*>/g,` `).split(/\s+/).filter(Boolean);return{words:t.length,min:Math.max(1,Math.ceil(t.length/200))}},C=()=>c.params()?.edit||new URLSearchParams(location.search).get(`edit`)||null,w=()=>{let e=l.user?.usuario?l.user:o(`wiSmile`)||{};if(!e.email)return`<div class="nu_err dpvc"><i class="fas fa-lock"></i><h2>Acceso restringido</h2><p>Inicia sesión para crear historias</p></div>`;let n=C();return`
  <div class="nu_wrap">
    <div class="nu_head">
      ...
      <div class="nu_head_right">
        ${n?`<a href="/${n}" class="nu_btn_outline" ${s(`Ver post`)}><i class="fas fa-eye"></i> Ver</a>`:`<button type="button" id="nu_preview_pg" class="nu_btn_outline" ${s(`Preview`)}><i class="fas fa-eye"></i> Preview</button>`}
      ...
      <div class="nu_left">
        <div class="nu_card">
          ...
          <div class="nu_slug_box">
            ...
            ${n?``:`<button type="button" id="nu_slug_reset" class="nu_slug_btn" ${s(`Regenerar`)}><i class="fas fa-rotate"></i></button>`}
          </div>
...
---
`,`Separador`]],[[`fa-code`,"`código`",`Código`],[`fa-image`,`![desc](url)`,`Imagen`],[`fa-link`,`[texto](url)`,`Enlace`]]].map((e,t)=>`<div style="display:flex;gap:0.4vh${t<3?`;border-right:1px solid var(--brd);padding-right:0.6vh;margin-right:0.2vh`:``}">${e.map(([e,t,n])=>`<button type="button" class="nu_tool" data-tag='${t}' ${s(n)}><i class="fas ${e}"></i></button>`).join(``)}</div>`).join(``)}</div>
      ...
      <div class="nu_right">
        ...
        <div class="nu_card">
          ...
          <div style="display:flex; flex-direction:column; gap:1vh;">
            ...
            <div id="nu_img_top_prev" class="nu_img_prev dpn"><img id="nu_img_top_el" src="" alt=""/><button type="button" id="nu_img_top_clear" class="nu_img_clear" ${s(`Quitar`)}><i class="fas fa-xmark"></i></button></div>
          </div>
        </div>
