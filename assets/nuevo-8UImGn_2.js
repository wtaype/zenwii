import{n as e}from"./vendor-BuoCFfzO.js";import{l as t}from"./wii-DQBqtwtl.js";import{C as n,S as r,_ as i,b as a,d as o,n as s,r as c}from"./widev-DfeMkeQH.js";import{t as l}from"./preload-helper-Dq_6WaEp.js";import{P as u,lt as d,on as f,qt as p,rt as m}from"./firebase-WP_1NxOL.js";import{n as h}from"./firebase-jIxv3xsb.js";import{a as g,b as _,o as v,t as y,u as b}from"./devblog-C8pZ2qLL.js";var x=e=>e.trim().toLowerCase().normalize(`NFD`).replace(/[\u0300-\u036f]/g,``).replace(/\b(el|la|los|las|de|del|en|un|una|y|a|con|por|para|que|es|se)\b/g,` `).replace(/[^a-z0-9\s]/g,``).replace(/\s+/g,`_`).replace(/_{2,}/g,`_`).replace(/^_|_$/g,``).slice(0,50),S=e=>{let t=e.replace(/<[^>]*>/g,` `).split(/\s+/).filter(Boolean);return{words:t.length,min:Math.max(1,Math.ceil(t.length/200))}},C=()=>a.params()?.edit||new URLSearchParams(location.search).get(`edit`)||null,w=()=>{let e=i.user?.usuario?i.user:o(`wiSmile`)||{};if(!e.email)return`<div class="nu_err dpvc"><i class="fas fa-lock"></i><h2>Acceso restringido</h2><p>Inicia sesión para crear historias</p></div>`;let r=C();return`
  <div class="nu_wrap">
    <div class="nu_head">
      ...
      <div class="nu_head_right">
        ${r?`<a href="/${r}" class="nu_btn_outline" ${n(`Ver post`)}><i class="fas fa-eye"></i> Ver</a>`:`<button type="button" id="nu_preview_pg" class="nu_btn_outline" ${n(`Preview`)}><i class="fas fa-eye"></i> Preview</button>`}
      ...
      <div class="nu_left">
        <div class="nu_card">
          ...
          <div class="nu_slug_box">
            ...
            ${r?``:`<button type="button" id="nu_slug_reset" class="nu_slug_btn" ${n(`Regenerar`)}><i class="fas fa-rotate"></i></button>`}
          </div>
