import{n as e}from"./vendor-BuoCFfzO.js";import{i as t,s as n}from"./rutas-DP-LLXJj.js";import{SUGERENCIAS as r,detectarTema as i}from"./contexto-CvMfmcs0.js";import"./waa-ClgJHSI_.js";var a=()=>{let e=r.general,t=n().replace(/, $/,``).toLowerCase();return`
<div class="miia">
...
</div>`},o=!1,s=0,c=null,l=[],u=()=>({$msg:e(`#miiaMessages`),$inp:e(`#miiaInput`),$btn:e(`#miiaSend`)}),d=(t=!1)=>{let n=e(`.miia_messages_wrap`)[0];n&&(t?n.scrollTo({top:n.scrollHeight,behavior:`smooth`}):n.scrollTop=n.scrollHeight)},f=async()=>c??=await t(()=>import(`./brain-DLFwwl9w.js`),[]),p=e=>e.replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/\n/g,`<br>`).replace(/\*\*(.*?)\*\*/g,`<strong>$1</strong>`).replace(/\*(.*?)\*/g,`<strong>$1</strong>`),m=(t,n)=>{let{$msg:r}=u(),i=new Date().toLocaleTimeString(`es-PE`,{hour:`2-digit`,minute:`2-digit`}),a=e(`
