import{n as e}from"./vendor-BuoCFfzO.js";import{i as t}from"./widev-DfeMkeQH.js";import{t as n}from"./preload-helper-Dq_6WaEp.js";import{n as r,t as i}from"./contexto-k5L1XX3V.js";import"./waa-BMsdf8hj.js";var a=()=>{let e=i.general,n=t().replace(/, $/,``).toLowerCase();return`
<div class="miia">
  ...
  <div class="miia_input_area wi_fadeUp visible">
...
</div>`},o=!1,s=0,c=null,l=[],u=()=>({$msg:e(`#miiaMessages`),$inp:e(`#miiaInput`),$btn:e(`#miiaSend`)}),d=(t=!1)=>{let n=e(`.miia_messages_wrap`)[0];n&&(t?n.scrollTo({top:n.scrollHeight,behavior:`smooth`}):n.scrollTop=n.scrollHeight)},f=async()=>c??=await n(()=>import(`./brain-CGRyq3xZ.js`),[]),p=e=>e.replace(/</g,`&lt;`).replace(/>/g,`&gt;`).replace(/\n/g,`<br>`).replace(/\*\*(.*?)\*\*/g,`<strong>$1</strong>`).replace(/\*(.*?)\*/g,`<strong>$1</strong>`),m=(t,n)=>{let{$msg:r}=u(),i=new Date().toLocaleTimeString(`es-PE`,{hour:`2-digit`,minute:`2-digit`}),a=e(`
    ...
    </div>`),d();let o=e(`#${a}`),c=Array.from(t),l=0,f=0,m=()=>{l<c.length?(o.html(p(c.slice(0,l+1).join(``))),l++,Date.now()-f>100&&(d(),f=Date.now()),setTimeout(m,15)):(o.removeAttr(`id`),d(!0),n?.())};m()},_=t=>{e(`.miia_contextual_suggestions`).remove();let n=i[t]??i.general;if(!n?.length)return;let r=`
