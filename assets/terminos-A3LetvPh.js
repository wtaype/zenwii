import{n as e}from"./vendor-BuoCFfzO.js";import{D as t,O as n}from"./rutas-CMyKUOUs.js";/* empty css               *//* empty css                 */var r=[{ico:`fa-users`,color:`#0EBEFF`,num:`01`,tit:`Uso de la app`,body:`<p>${n} es una app para guardar notas, tareas, ideas y proyectos, organizar información en tablas inteligentes y sincronizar datos en tiempo real. Debe usarse con información real, respeto y sin finalidades ilegales.</p>`},{ico:`fa-shield-halved`,color:`#29C72E`,num:`02`,tit:`Cuenta y sincronización`,body:`<p>Puedes iniciar sesión con Google o email. Sincronizamos tu perfil, notas, listas, tablas y ajustes con Firebase para que la app sea rápida, confiable y accesible desde cualquier dispositivo.</p>`},{ico:`fa-globe`,color:`#FF5C69`,num:`03`,tit:`Planes disponibles`,body:`<p>El plan base está disponible como inicio. Planes premium quedan preparados para más capacidad, almacenamiento, colaboración y funciones avanzadas. Los límites pueden actualizarse con aviso razonable.</p>`},{ico:`fa-gavel`,color:`#7000FF`,num:`04`,tit:`Derechos y propiedad intelectual`,body:`<p>${n} es un proyecto desarrollado por Wilder Taype. El diseño, código y funcionalidades pertenecen al proyecto; tus datos personales, notas y contenido guardado siguen siendo tuyos en todo momento.</p>`},{ico:`fa-triangle-exclamation`,color:`#FFDA34`,num:`05`,tit:`Limitación de responsabilidad`,body:`<p>${n} ayuda a organizar información, pero debes revisar que tus datos sean correctos y completos. El servicio puede depender de permisos, conexión a internet, disponibilidad de Firebase y configuración del dispositivo.</p>`},{ico:`fa-arrows-rotate`,color:`#0EBEFF`,num:`06`,tit:`Cambios en los términos`,body:`<p>Podemos actualizar funciones, texto legal y detalles del servicio con el tiempo. El uso continuado de ${n} después de esos cambios implica aceptación de la versión vigente.</p>`}],i=()=>`
<main id="wimain">
<div class="ac_wrap tm_wrap">
  ...
  <section class="ac_hero tm_hero">
    ...
    <div class="ac_hero_body">
      ...
      <p class="ac_hero_sub">
        Reglas claras para usar <strong>${n}</strong>, cuidar tus datos y mantener una experiencia profesional y segura.
      </p>
...
`,a=null,o=()=>{let t=new IntersectionObserver(t=>{t.forEach(t=>{t.isIntersecting&&e(t.target).addClass(`visible`)})},{threshold:.1});a=t,e(`.wi_fadeUp`).each(function(){t.observe(this)}),e(document).on(`click.terminos`,`.tm_nav`,function(t){t.preventDefault();let{rutas:n}=window._wiRutas??{};n?.navigate?.(e(this).attr(`href`))}),e(document).on(`click.terminos`,`.tm_index_item`,function(t){t.preventDefault();let n=document.querySelector(e(this).attr(`href`));n&&window.scrollTo({top:n.getBoundingClientRect().top+scrollY-90,behavior:`smooth`})}),window.wiInitTips&&window.wiInitTips(),console.log(`📜 ${n} Términos cargados`),window.__WIREADY__=!0},s=()=>{a?.disconnect?.(),a=null,e(document).off(`.terminos`)};export{s as cleanup,o as init,i as render};