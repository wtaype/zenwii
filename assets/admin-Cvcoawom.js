import{n as e}from"./vendor-BuoCFfzO.js";import{t}from"./wii-DQBqtwtl.js";import{h as n,o as r,p as i}from"./rutas-Cm_3kJJL.js";import{c as a,f as o,p as s,r as c}from"./firebase-D_Qc_hgv.js";import{n as l}from"./firebase-CkLzmU2G.js";var u=()=>i(`wiSmile`),d=`amUsersTotal`,f=`amUsersPro`,p=`amOrgsTotal`,m=`amLessonsTotal`,h=()=>{let e=u();return!e||e.rol!==`admin`?`<div class="am_page"><div class="am_empty"><i class="fas fa-ban"></i> Acceso denegado.</div></div>`:`
  <div class="am_page">
  ...
  </div>`},g=async()=>{let t=u();!t||t.rol!==`admin`||(e(document).off(`.am`),v(),y(),e(document).on(`click.am`,`#am_btn_refresh`,function(){let t=e(this).find(`i`).addClass(`fa-spin`);y(!0).then(()=>{setTimeout(()=>t.removeClass(`fa-spin`),500)})}))},_=()=>{e(document).off(`.am`)};function v(){e(`#am_n_total`).text(i(d)||`—`),e(`#am_n_pro`).text(i(f)||`—`),e(`#am_n_org`).text(i(p)||`—`),e(`#am_n_les`).text(i(m)||`45`)}async function y(t=!1){try{let u=s(l,`smiles`);if(t||!i(d)){let t=(await c(u)).data().count;n(d,t),e(`#am_n_total`).text(t)}if(t||!i(f)){let t=(await c(a(u,o(`rol`,`in`,[`gestor`,`empresa`,`admin`])))).data().count;n(f,t),e(`#am_n_pro`).text(t)}if(t||!i(p)){let t=(await c(a(u,o(`rol`,`==`,`empresa`)))).data().count;n(p,t),e(`#am_n_org`).text(t)}t&&r(`Estadísticas sincronizadas`,`success`)}catch(e){console.error(`[Admin] Error cargando stats:`,e),t&&r(`Error sincronizando`,`error`)}}export{_ as cleanup,g as init,h as render};